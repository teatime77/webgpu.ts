...
struct CylinderInstance {
    bottomCenter: vec3<f32>,
    radius: f32,              // Placed here to fulfill vec3 alignment rules
    topCenter: vec3<f32>,
    pad: f32,                 // Padding to align the color vec4
    color: vec4<f32>,
}
...
fn main(
    ...
    let bottom = instance.bottomCenter;
    let top    = instance.topCenter;
