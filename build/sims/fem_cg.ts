// ============================================================================
// fem_cg simulation — authored via the typed builder API.
...
export default defineSimulation({
    ...
    uis: [
        ui.range({ name: "stiffness", label: "Stiffness", scale: "log",
                   min: 0.01, max: 100.0, step: 0.01, format: "%.3f" }),
        ui.range({ name: "gravity",   label: "Gravity",
                   min: 0.0, max: 0.2, step: 0.001, restart: true }),
        ui.int(  { name: "cg_iters",  label: "CG iterations",
    ...
    resources: {
        Params: uniform({
            dt: "f32", stiffness: "f32", gravity: "f32", damping: "f32",
            gridWidth: "f32", gridHeight: "f32",
            segmentsX: "f32", segmentsY: "f32",
            numNodes: "f32", numElements: "f32",
        }),
